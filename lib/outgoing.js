...
Outgoing.prototype.reqNewsProviders = function () {
    var version = 1;

    this._send(C.OUTGOING.REQ_NEWS_PROVIDERS);
}
Outgoing.prototype.reqHistoricalNews = function (requestId, conId, providerCodes, startDateTime = '', endDateTime = '', totalResults = 10) {

    this._send(C.OUTGOING.REQ_HISTORICAL_NEWS,requestId, conId, providerCodes, startDateTime , endDateTime , totalResults );
}
