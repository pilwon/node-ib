...
IB.prototype.reqNewsProviders = function(){
  this._send('reqNewsProviders');

}
IB.prototype.reqHistoricalNews = function(requestId, conId, providerCodes, startDateTime = '', endDateTime = '', totalResults = 10){
  this._send('reqHistoricalNews',requestId, conId, providerCodes, startDateTime , endDateTime , totalResults ,null);
